...
*Количество обнаруженных дубликатов в популярных Java проектах.*
...
Во время проведения рефакторинга, не стоит пренебрегать возможностями среды разработки. С их помощью, и с помощью плагина, рефакторинг можно значительно упростить. Например, можно найти множество полезных функций в контекстном меню **Refactor** или в подсказках к инспекциям кода (``Alt + Enter`` инспекции).
